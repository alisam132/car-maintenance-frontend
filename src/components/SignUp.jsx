...
function SignUp() {
  ...
  const handleSubmit = async (evt) => {
    ...
    setIsLoading(true)
    try {
      const response = await axios.post("https://car-maintenance-backend-cefb13b79607.herokuapp.com/auth/signup/", formData)
  ...
  return (
    <Form onSubmit={handleSubmit}>
      ...
      <Button variant="primary" type="submit" onClick={() => navigate('/auth/login')}>
        Login
      </Button>
