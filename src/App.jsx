...
function App() {
    ...
    try {
      const token = localStorage.getItem("accessToken")
        if (token){
          ...
          const newCar = await axios.post("https://car-maintenance-backend-cefb13b79607.herokuapp.com/cars/new/", formData, config)
    ...
    try {
      const token = localStorage.getItem("accessToken")
        if (token){
          ...
          const newCarsRecords = await axios.post("https://car-maintenance-backend-cefb13b79607.herokuapp.com/carsrecords/new/", formData, config)
  ...
  const handleDeleteCarsRecords = async (carsRecordsId) => {
    ...
    if (token){
      ...
      const deleteCarsRecords = await axios.delete(`https://car-maintenance-backend-cefb13b79607.herokuapp.com/carsrecords/delete/${carsRecordsId}`, config)
  ...
  const handleDeleteCar = async (carId) => {
    ...
    if (token){
      ...
      const deleteCar = await axios.delete(`https://car-maintenance-backend-cefb13b79607.herokuapp.com/cars/delete/${carId}`, config)
    ...
    try {
      const token = localStorage.getItem("accessToken")
        if (token){
          ...
          const updatedCar = await axios.put(`https://car-maintenance-backend-cefb13b79607.herokuapp.com/cars/update/${carId}`, formData, config)
    ...
    try {
      const token = localStorage.getItem("accessToken")
        if (token){
          ...
          const updatedCarsRecords = await axios.put(`https://car-maintenance-backend-cefb13b79607.herokuapp.com/carsrecords/update/${carsRecordsId}`, formData, config)          
  ...
  useEffect(() => {
    const fetchAllCars = async () => {
        ...
        if (token){
          ...
          const response = await axios.get("https://car-maintenance-backend-cefb13b79607.herokuapp.com/cars/", config)
    ...
    const fetchAllCarmaintenance = async () => {
      ...
      if (token){
        ...
        const response = await axios.get("https://car-maintenance-backend-cefb13b79607.herokuapp.com/carsrecords/", config)
  ...
  return (
    <BrowserRouter>
      <Routes>
        ...
        <Route path='/auth/signup' element={<SignUpAndLogout/>}/>
      </Routes>
